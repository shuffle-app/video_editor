...
class _TrimSliderState extends State<TrimSlider> with AutomaticKeepAliveClientMixin<TrimSlider> {
  ...
  void _onHorizontalDragStart(DragStartDetails details) {
    ...
    if (isNotScrollBouncingBack && !_scrollController.position.isScrollingNotifier.value) {
      final touchProgressStartPosition = progressTrim - _touchMargin;
      final touchProgressEndPosition = progressTrim + _touchMargin;
      if (pos.dx >= touchProgressStartPosition && pos.dx <= touchProgressEndPosition) {
      ...
      return SizedBox(
          ...
          child: Stack(children: [
            ...
            GestureDetector(
              ...
              // onTapDown: (details) {
              //   print('started tap at local ${details.localPosition}');
              //   print('started tap at global ${details.globalPosition}');
              //   if (_boundary == null) {
